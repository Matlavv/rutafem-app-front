        ...
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.content}>
                ...
                <Text style={styles.description}>
                    Nous te demandons une pièce d'identité uniquement pour vérifier ton profil. Tes
                    données sont protégées, ne sont jamais partagées, et seront utilisées uniquement
